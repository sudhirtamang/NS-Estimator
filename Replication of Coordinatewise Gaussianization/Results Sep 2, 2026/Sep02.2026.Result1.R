...
doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.05, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega")
)

doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.05, robust_KTau, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
...
doSimulation2(Grho, FALSE, TRUE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.05, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega")
)

print("Now for the transformed and corrected Data!\n\n")

doSimulation2(Grho, TRUE, TRUE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.05, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega")
)

p_conta <- 0.1
print("Simulation for 10% Contamination!!!!!!!!!!!!!!\n\n")

doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.1, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.1, robust_KTau, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 Kendall, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 Kendall, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, FALSE, TRUE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.1, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, TRUE, TRUE, lower = 0.01, p = 120, n=200, R=RUNs, p_conta=0.1, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega")
)
...
p_conta <- 0.05
print("Simulation for 5% Contamination!!!!!!!!!!!!!!\n\n")
doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.05, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega")
)

doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.05, robust_KTau, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 Kendall, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 Kendall, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, FALSE, TRUE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.05, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, TRUE, TRUE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.05, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.1, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, FALSE, FALSE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.1, robust_KTau, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 Kendall, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 Kendall, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, FALSE, TRUE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.1, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T, SPARSE: ChainOmega")
)
...
doSimulation2(Grho, TRUE, TRUE, lower = 0.01, p = 200, n=200, R=RUNs, p_conta=0.1, sampleCOVest, generate_sparse_omega, medDev,
              rmvnorm_precision_n, TPrate, TNrate, FNrate, FPrate,
              paste0("===================================== START:::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega"),
              paste0("===================================== END:::::::::::", p_conta*100,  "% rowwise n = 200, p =120 SampleCov.T.C, SPARSE: ChainOmega")
)
