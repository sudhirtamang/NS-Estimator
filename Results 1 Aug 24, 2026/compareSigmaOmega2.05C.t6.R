...
for(itr in 1:RUNs){
  ...
  if(itr %in% x.values){
    png(paste0("x.Plot", itr, "05C.t6.png"), width = 800, height = 600)
  ...
  if(itr %in% contam.x.values){
    png(paste0("contam.Plot", itr, "05C.t6.png"), width = 800, height = 600)
  ...
  if(itr %in% contam.Tx.values){
    png(paste0("contam.Tx.Plot", itr, "05C.t6.png"), width = 800, height = 600)
  ...
  if(itr %in% contam.Tx.values.C){
    png(paste0("contam.Tx.C.Plot", itr, "05C.t6.png"), width = 800, height = 600)
